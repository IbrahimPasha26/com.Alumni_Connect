...
<body onload="hideMessage()">
            ...
            <div class="panel">
                ...
                <div class="content-container">
                    ...
                    <div class="tab" id="tab3">
                        <h2>Remove Alumni</h2>
                        <form action="removeAlumni" method="POST" onsubmit="return confirmRemoval()">
                            <div class="field">
    ...
    <script>
        ...
        {
            return confirm("Are you sure you want to remove this alumni? This action cannot be undone.");
        }
        function confirmLogout() {
            if (confirm("Are you sure you want to logout?")) {
                window.location.href = 'userLogin.html'; // Redirect to the logout servlet
            }
        }
